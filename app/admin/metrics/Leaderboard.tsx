interface LeaderboardProps {
  leaderboardData: { username: string; accuracy: number; user_id: number }[];
}
      ...
      <div className="overflow-x-auto shadow-md rounded-lg">
        <table className="min-w-full table-auto text-center">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-4 py-2 text-sm font-medium text-gray-500">User ID</th>
              <th className="px-4 py-2 text-sm font-medium text-gray-500">Username</th>
