...
import { faTimes } from '@fortawesome/free-solid-svg-icons'; // Import the Font Awesome close (X) icon
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <Dialog.Panel className="relative">
              <div className="relative">
                ...
                >
                  <FontAwesomeIcon icon={faTimes} className="w-5 h-5 text-black" /> {/* Font Awesome close icon */}
                </button>
